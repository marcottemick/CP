...
encodeur_OD = joblib.load('C:\CAS_PRATIQUES\code\models_encoders\encodeur_2O.joblib')

encodeur_OG = joblib.load('C:\CAS_PRATIQUES\code\models_encoders\encodeur_OG.joblib')

encodeur_ODG = joblib.load('C:\CAS_PRATIQUES\code\models_encoders\encodeur_2O.joblib')

 

model_OG = tf.keras.models.load_model('C:\CAS_PRATIQUES\code/models_encoders/vgg16_side_OG2ID_classif')

model_OG.trainable = False

model_OD = tf.keras.models.load_model('C:\CAS_PRATIQUES\code/models_encoders/vgg16_side_OD2ID_classif')

model_OD.trainable = False

model_ODG = tf.keras.models.load_model('C:\CAS_PRATIQUES\code/models_encoders/vgg16_side_O2ID_classif')
